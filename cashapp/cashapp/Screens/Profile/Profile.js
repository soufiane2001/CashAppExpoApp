...
<TouchableOpacity   style={{display:'flex',flexDirection:'row',paddingHorizontal:'5%',alignItems:'center',width:'100%',marginTop:'2.5%',marginRight:'1%'}} onPress={()=>{toggleBudgetd()}}>
...
<Modal visible={isModalInitial} animationIn="slideInUp" animationOut="slideOutDown">
   <View style={styles.modal}>
     <Text style={styles.modalTitle}>Entrez le budget initial</Text>
...
<TouchableOpacity onPress={()=>{toggleBudgetm(index)}} style={{backgroundColor:'#40DC01',color:'white',paddingHorizontal:'2.5%',paddingVertical:'1%',borderRadius:10,display:'flex',flexDirection:'row',alignItems:'center',alignSelf:'flex-start',marginRight:'1%',marginTop:'2%'}}>

<Text style={{fontSize:getResponsiveFontSize(13),fontFamily:'PoppinsMedium',color:'white',textAlign:'center',}}>Montant</Text>
