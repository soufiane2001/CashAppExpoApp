...
const Setupdepense=({navigation,route }) =>{
  ...
  {type:"vignette",montant:0,depense:[],photo:'https://cdn-icons-png.flaticon.com/512/744/744465.png'},
...
<Text style={{fontSize:getResponsiveFontSize(14),fontFamily:'PoppinsMedium',color:'black',textAlign:'center'}}>Entrez vos dépenses </Text>
