...
function Setupbudget({navigation ,route}) {
  ...
  const [budgets, setBudget] = useState([{type:"Salaire",revenu:0,date:31},
                                         ...
                                         {type:"Revenu Locatif",revenu:0,date:31},
      ...
      colors={['#FF5733', '#FFC300', '#36A2EB']}
       ...
       >
           ...
           <View style={{backgroundColor:'white',height:'80%',paddingTop:'7%',borderTopLeftRadius: getResponsiveFontSize(55),borderTopRightRadius:getResponsiveFontSize(55)}}>
                ...
                <Text style={{fontSize:getResponsiveFontSize(15),fontFamily:'PoppinsMedium',color:'black',textAlign:'center'}}>Svp Entrez vos montant des revenus</Text>
                ...
                <TouchableOpacity   style={{display:'flex',flexDirection:'row',paddingHorizontal:'5%',alignItems:'center',height:'5%',width:'100%',marginTop:'2.5%',marginRight:'1%'}} onPress={()=>{toggleModal2()}}>
 
 <Image 
        source={require('../../assets/cash.png')}
    style={{width:getResponsiveFontSize(35),height:getResponsiveFontSize(35),resizeMode:"contain",marginRight:'1%'}}
 />
<Text style={{fontSize:getResponsiveFontSize(12),fontFamily:'PoppinsMedium',color:'#515151',textAlign:'center'}}>Merci de choisir la date du début</Text>
  ...
  {budgets.map((x,index)=>
            ...
            <View key={index} style={{backgroundColor:'white',paddingHorizontal:'0%',paddingVertical:'5.5%',borderRadius:15,borderWidth:1,borderColor:'#F7F7F7',marginTop:'4%',
                          display:'flex',flexDirection:'row',justifyContent:'space-between',alignItems:'center',width:'93%',marginLeft:'3.2%',
                         ...Platform.select({
                                           ios: {
                                                  shadowColor: 'black',
         ...
         <Text style={{width:'27%',fontSize:getResponsiveFontSize(13),fontFamily:'PoppinsMedium',color:'black',textAlign:'center',marginLeft:'0%'}}>{x.type}</Text>


                <View style={{backgroundColor:'#4816FF',width:'26%',color:'white',paddingHorizontal:'1%',borderRadius:12,
                             alignSelf:'flex-start',marginRight:'4%',marginTop:'2%',display:'flex',flexDirection:'row',alignItems:'center',justifyContent:'center'
                               }}>



                  <Text style={{fontSize:getResponsiveFontSize(14),fontFamily:'PoppinsMedium',color:'white',textAlign:'center',display:'flex',marginTop:'2%'}}>{x.revenu} dh</Text></View>




                  <View style={{backgroundColor:'#FF4637',width:'10%',color:'white',paddingVertical:'1%',borderRadius:10,display:'flex',flexDirection:'row',alignItems:'center',alignSelf:'flex-start',marginLeft:'-2.5%',marginRight:'2%',marginTop:'2%',justifyContent:'center'}}>
                   <Text style={{fontSize:getResponsiveFontSize(12),fontFamily:'PoppinsMedium',color:'white',textAlign:'center',}}>{x.date}</Text>
                  </View>
                     ...
                     <TouchableOpacity onPress={()=>{toggleModal(index)}} style={{backgroundColor:'#40DC01',color:'white',paddingHorizontal:'2.5%',paddingVertical:'1%',borderRadius:10,display:'flex',flexDirection:'row',alignItems:'center',alignSelf:'flex-start',marginRight:'1%',marginTop:'2%'}}>
                          
                          <Text style={{fontSize:getResponsiveFontSize(13),fontFamily:'PoppinsMedium',color:'white',textAlign:'center',}}>Modifier</Text>
